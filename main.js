...
=============================== */
const AppConfig = {
  // For local development, an empty string uses relative paths.
  // For AWS production, you might change this to your API server's URL.
...
const FormValidator = {
  ...
  async handleFormSubmit(form) {
    ...
    if (form.id === 'loginForm') {
      url = `${AppConfig.API_BASE_URL}API/login.php`;
      redirect = 'index.html';
    } else if (form.id === 'registerForm') {
      url = `${AppConfig.API_BASE_URL}API/register.php`;
      redirect = 'login.html';
    } else if (form.id === 'checkoutForm') {
      url = `${AppConfig.API_BASE_URL}API/checkout.php`;
      ...
      url = `${AppConfig.API_BASE_URL}API/contact.php`;
    }
...
async function loadMenu() {
  try {
    const response = await fetch(`${AppConfig.API_BASE_URL}API/products.php`);
